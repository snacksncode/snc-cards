...
const Close = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g id="Iconly/Bold/Close-Square" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Close-Square" transform="translate(1.999800, 1.999200)" fill="currentColor" fillRule="nonzero">
