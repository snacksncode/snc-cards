...
const Tick = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g id="Iconly/Bold/Tick-Square" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Tick-Square" transform="translate(2.000100, 1.999900)" fill="currentColor" fillRule="nonzero">
